...
public class Slogin extends javax.swing.JFrame {
    ...
    public Slogin() {
        ...
        getContentPane().setBackground(new java.awt.Color(240, 248, 255)); // Light blue
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MainFiles/one.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().length()==0 && jTextField2.getText().length()==0)
        {
            ...
            if(jTextField1.getText().equals("groupX") && jTextField2.getText().equals("12345"))
        {
